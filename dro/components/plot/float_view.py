...
from dro.dispatchers.circle_pattern import CirclePatternDispatcher
from dro.dispatchers.line_pattern import LinePatternDispatcher
from dro.dispatchers.rect_pattern import RectPatternDispatcher
